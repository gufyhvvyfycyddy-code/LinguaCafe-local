        ...
        <v-row class="mb-4" dense align="center">
            ...
            <v-col cols="12" sm="8" md="5">
                <v-btn-toggle v-model="activeFilter" mandatory dense class="flex-wrap">
                    ...
                    <v-btn small value="future" @click="applyFilter('future')">未到期</v-btn>
                    <v-btn small value="enabled" @click="applyFilter('enabled')">启用</v-btn>
                    <v-btn small value="disabled" @click="applyFilter('disabled')">停用</v-btn>
                    ...
                    <tr v-for="item in items" :key="item.review_card_id">
                        ...
                        <td>
                            ...
                            <template v-else>
                                ...
                                <v-btn v-if="item.fsrs_enabled" x-small text color="warning" @click="toggleEnabled(item)">停用</v-btn>
                                <v-btn v-else x-small text color="success" @click="toggleEnabled(item)">启用</v-btn>
