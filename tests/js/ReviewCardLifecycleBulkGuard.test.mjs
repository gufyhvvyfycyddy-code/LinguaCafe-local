...
const leechPath = join(root, 'resources', 'js', 'components', 'ReviewCards', 'ReviewCardLeechMutationSurface.vue');
...
test('Leech bulk suspend delegates to shared request owner', () => {
    ...
    assert.ok(!leech.includes('/review-cards/manage/bulk-lifecycle'));
});
