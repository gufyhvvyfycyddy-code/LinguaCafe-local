...
assert.match(masterAuthority, /Current Phase \| Browser\/ReviewCardManage Phase 3A — Card Info Drawer Extraction is Implemented \/ Automated Verified \/ Authenticated Network Acceptance Blocked \/ Incomplete; Phase 3B is not authorized/);
...
assert.match(openWork, /Browser \/ ReviewCardManage architecture convergence \| Phase 3A Implemented \/ Automated Verified \/ Authenticated Network Acceptance Blocked \/ Incomplete/);
...
assert.match(executionOrder, /Phase 3A Implemented \/ Automated Verified \/ Authenticated Network Acceptance Blocked \/ Incomplete/);
...
assert.match(index, /Browser\/ReviewCardManage Phase 3A — Card Info Drawer Extraction is implemented and automated verified, but authenticated Network acceptance is blocked[\s\S]*status is Incomplete and Phase 3B is not authorized/);
