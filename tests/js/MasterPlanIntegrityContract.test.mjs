...
const h11 = goal.indexOf('| H-11 | ACTIVE |');
...
assert.ok(h11 > h10, 'H-11 active regression must follow the H-10 capability probe');
...
assert.match(currentContext, /2026-08-29 current overlay/);
...
assert.match(currentContext, /H-11 final Web \+ Android \+ available-iOS regression/);
