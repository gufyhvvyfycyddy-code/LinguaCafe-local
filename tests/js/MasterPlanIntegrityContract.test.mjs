...
assert.match(master, /Current Phase \| Goal Phase G \+ G-GATE[^\n]*H-01[^\n]*H-05[^\n]*DONE[^\n]*H-06/);
assert.match(master, /H-00[\s\S]*DONE/);
assert.match(master, /H-03[^\n]*DONE/);
assert.match(master, /H-04[^\n]*DONE/);
assert.match(master, /H-05[^\n]*isolation\/privacy boundary[^\n]*DONE/);
assert.match(master, /H-06[^\n]*login\/public authentication convergence/);
...
const h06 = goal.indexOf('| H-06 | ACTIVE |');
...
assert.match(currentContext, /H-04[^\n]*DONE/);
assert.match(currentContext, /H-05[^\n]*isolation\/privacy boundary/);
assert.match(currentContext, /H-06[^\n]*login\/public authentication convergence/);
