...
assert.match(masterAuthority, /Current Phase \| Browser\/ReviewCardManage Phase 3A — Card Info Drawer Extraction is Accepted \/ Production Closed; Phase 3B-1 is Authorized Next \/ Not Started and Phase 3B-2 is Planned \/ Not Started/);
...
assert.match(openWork, /Browser \/ ReviewCardManage architecture convergence \| Phase 3A Accepted \/ Production Closed/);
...
assert.match(executionOrder, /Phase 3A Accepted \/ Production Closed/);
...
assert.match(index, /Browser\/ReviewCardManage Phase 3A — Card Info Drawer Extraction is Accepted \/ Production Closed[\s\S]*Phase 3B-1 is Authorized Next \/ Not Started[\s\S]*Phase 3B-2 is Planned \/ Not Started/);
