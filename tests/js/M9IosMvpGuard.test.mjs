...
assert.match(readerAcceptanceWorkflow, /-only-testing:AppUITests\/ReaderAcceptanceUITests\/testReaderSourceBindingAndPhraseGesture/);
assert.match(readerAcceptanceWorkflow, /run-command-with-timeout\.php --seconds=600/);
