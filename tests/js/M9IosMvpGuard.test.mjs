...
assert.match(storeMaterials, /Gambling: `No`/);
assert.match(storeMaterials, /Simulated Gambling: `None`/);
assert.match(storeMaterials, /Contests: `None`/);
assert.match(storeMaterials, /Loot Boxes: `No`/);
