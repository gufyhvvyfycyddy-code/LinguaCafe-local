...
assert.match(ipadSmokeBlock, /ipad-login-shell-raw\.png/);
assert.match(ipadSmokeBlock, /ipad-login-shell\.jpg/);
assert.match(ipadSmokeBlock, /sips -s format jpeg/);
assert.match(ipadSmokeBlock, /test "\$FORMAT" = "jpeg"/);
assert.match(ipadSmokeBlock, /test "\$ALPHA" = "no"/);
...
assert.match(iphoneSmokeBlock, /iphone-6\.9-login-shell-raw\.png/);
assert.match(iphoneSmokeBlock, /iphone-6\.9-login-shell\.jpg/);
assert.match(iphoneSmokeBlock, /sips -s format jpeg/);
assert.match(iphoneSmokeBlock, /test "\$FORMAT" = "jpeg"/);
assert.match(iphoneSmokeBlock, /test "\$ALPHA" = "no"/);
...
assert.doesNotMatch(xcodeCapabilityWorkflow, /LC_IOS_STORE_IPHONE_SIM_UDID/);
