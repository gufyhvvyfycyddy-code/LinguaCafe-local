...
| 主线 | 进度 | 说明 |
|------|------|------|
| 总体架构收口 | ≈ 79% | FSRS/TextBlock/WordSense 各线 stabilization、测试、文档收口 |
| 复习主线稳定 | ≈ 85% | WordSense/ReviewCard/FSRS 核心链路已锁定，smoke harness 持续补充 |
| 页面真实验收 | ≈ 65% | 到期卡评分 + More 菜单 + occurrence 写入路径已验收；剩余页面路径持续补充 |
