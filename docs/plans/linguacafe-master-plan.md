...
| 8 | AI Study Card service convergence | Current | Phase 7A lifecycle、7B preview/final package 已关闭；继续拆 validation/dedupe、source binding、generation | coordinator 1,065 → 487 行；lifecycle owner 283 行；package owner 255 行 | Phase 7 design；7B 195 tests / 1,519 assertions；Phase 7A official Browser cancel/restore | lifecycle/package closed；validation slice current |
