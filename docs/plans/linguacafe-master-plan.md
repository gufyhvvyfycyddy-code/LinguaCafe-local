...
> **最后更新**：2026-07-08 (AIStudyCardV5GenerationCountsBeforeConfirm-1)
...
V5 确认前计数与 0 已填按钮状态已收口。下一步可考虑的方向（仍需网页端总流程设计师确认）：

1. V5 对话框内对“将跳过”的项给出更明确的视觉标记（如灰化或删除线），让用户在对话框内就能识别哪些项会被跳过。
