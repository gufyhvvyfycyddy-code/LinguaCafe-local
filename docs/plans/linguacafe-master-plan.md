...
| 8 | AI Study Card service convergence | Current | Phase 7A lifecycle 已关闭；继续拆 package、validation/dedupe、source binding、generation | coordinator 1,065 → 784 行；`AiStudyCardPendingLifecycleService` 283 行 | Phase 7 design；197 tests / 1,519 assertions；official Browser cancel/restore | lifecycle closed；package slice current |
