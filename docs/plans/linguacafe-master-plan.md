...
| 8 | AI Study Card service convergence | Current | Phase 7A lifecycle、7B package、7C validation 已关闭；继续拆 source binding、generation | coordinator 1,065 → 334 行；lifecycle/package/validation 均有 owner | Phase 7 design；7C 199 tests / 1,545 assertions；Phase 7A official Browser cancel/restore | lifecycle/package/validation closed；source binding current |
