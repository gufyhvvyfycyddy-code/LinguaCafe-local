...
> | Current Phase | Browser/ReviewCardManage Phase 3C-1 — Due-now / Reset Scheduling Mutation Family is Accepted / Production Closed; Phase 3C-2 Lifecycle Mutation Family is Authorized Next / Not Started |
...
| 3 | Browser / ReviewCardManage architecture convergence | Phase 3C-1 Accepted / Production Closed | Phase 3A 抽取只读 Card Info；Phase 3B-1 抽取 Search；Phase 3B-2 抽取 Table；Phase 3C-1 抽取 Due-now / Reset Scheduling Mutation Family | `ReviewCardManage.vue` 1,489 行、16 个 direct `axios.` references、9 个 `v-dialog`；`ReviewCardSchedulingMutationSurface.vue` 117 行、2 个调度 POST、2 个确认框；重复 `setDueNow()` 已删除 | `docs/plans/review-card-manage-architecture-convergence-plan.md`；ADR-0012–0014、0017；2026-07-16 authenticated Chrome acceptance | Phase 3C-2 Lifecycle Mutation Family Authorized Next / Not Started；本轮停止 |
...
| 3 | Browser / ReviewCardManage convergence | Phase 3C-1 Accepted / Production Closed | Card Info、Search、Table 与 Due-now / Reset Scheduling Mutation Surface 已形成独立职责所有者；父组件 1,489 行、16 个请求、9 个弹窗；Phase 3C-2 Lifecycle Mutation Family Authorized Next / Not Started；见 `review-card-manage-architecture-convergence-plan.md` |
