...
> | State | Work |
> |---|---|
> | Production Closed | Queue Order; Custom Study 1A; Manual Sense POS + shared form; Settings architecture convergence; Preset V1A; Preset V1B; Preset V1C; Preset V1D; Browser/ReviewCardManage Phase 3A; Browser/ReviewCardManage Phase 3B-1; Browser/ReviewCardManage Phase 3B-2 |
...
> | Current Phase | Browser/ReviewCardManage Phase 3B-2 — Table / Columns / Pagination / Selection / Export is Accepted / Production Closed; Phase 3C is Authorized Next / Not Started |
...
| 3 | Browser / ReviewCardManage architecture convergence | Phase 3B-2 Accepted / Production Closed | Phase 3A 抽取只读 Card Info；Phase 3B-1 抽取 Search / Filter / Saved Search；Phase 3B-2 抽取 Table / Columns / Pagination / Selection / Export | `ReviewCardManage.vue` 1,540 行、19 个 direct `axios.` references、11 个 `v-dialog`；`ReviewCardTableSurface.vue` 872 行；Card Info、Search Surface 与 Table Surface 各有单一职责所有者，学习报告深链与表格当前行已同步 | `docs/plans/review-card-manage-architecture-convergence-plan.md`；ADR-0012–0014、0017；2026-07-16 authenticated Chrome acceptance | Phase 3C Authorized Next / Not Started；本轮停止 |
...
| 3 | Browser / ReviewCardManage convergence | Phase 3B-2 Accepted / Production Closed | Card Info Drawer、Search / Filter / Saved Search Surface 与 Table / Columns / Pagination / Selection / Export Surface 均已完成职责抽取和 authenticated Chrome/Network 验收；父组件 1,540 行；学习报告深链与当前行同步已补齐；Phase 3C Authorized Next / Not Started；见 `review-card-manage-architecture-convergence-plan.md` |
