...
> | State | Work |
> |---|---|
> | Production Closed | Queue Order; Custom Study 1A; Manual Sense POS + shared form; Settings architecture convergence; Preset V1A; Preset V1B; Preset V1C; Preset V1D; Browser/ReviewCardManage Phase 3A |
...
> | Current Phase | Browser/ReviewCardManage Phase 3A — Card Info Drawer Extraction is Accepted / Production Closed; Phase 3B-1 is Authorized Next / Not Started and Phase 3B-2 is Planned / Not Started |
...
| 3 | Browser / ReviewCardManage architecture convergence | Phase 3A Accepted / Production Closed | Anki Browser 式搜索、表格、Card Info 与危险操作分区；Phase 3A 已抽取并关闭只读 Card Info Drawer | `ReviewCardManage.vue` 2,792 行、22 个 direct `axios.` references、12 个 `v-dialog`；Card Info canonical detail request 仅由子组件负责 | `docs/plans/review-card-manage-architecture-convergence-plan.md`；ADR-0012–0014、0017；2026-07-16 authenticated Chrome acceptance | Phase 3B-1 Authorized Next / Not Started；Phase 3B-2 Planned / Not Started；本轮停止 |
...
| 3 | Browser / ReviewCardManage convergence | Phase 3A Accepted / Production Closed | `ReviewCardManage.vue` 已完成 Card Info Drawer Extraction 与 authenticated Chrome/Network 验收；Phase 3B-1 Authorized Next / Not Started，Phase 3B-2 Planned / Not Started；见 `review-card-manage-architecture-convergence-plan.md` |
