...
> | State | Work |
> |---|---|
> | Production Closed | Queue Order; Custom Study 1A; Manual Sense POS + shared form; Settings architecture convergence; Preset V1A; Preset V1B; Preset V1C; Preset V1D; Browser/ReviewCardManage Phase 3A; Browser/ReviewCardManage Phase 3B-1 |
...
> | Current Phase | Browser/ReviewCardManage Phase 3B-1 — Search / Filter / Saved Search Surface is Accepted / Production Closed; Phase 3B-2 is Authorized Next / Not Started |
...
>
> **Architecture status correction**: the old “overall architecture closure 100%” statement is historical. Settings convergence removed two former 1,000-line hotspots. The fresh baseline is 27 production files over 500 lines, 10 over 1,000, and 2 over 1,500; current assessment remains **6.5/10, localized high burden** because `ReviewCardManage.vue`, `TextBlockGroup.vue`, and `SenseReview.vue` remain large.
>
...
| 3 | Browser / ReviewCardManage architecture convergence | Phase 3B-1 Accepted / Production Closed | Phase 3A 抽取只读 Card Info；Phase 3B-1 抽取 Search / Filter / Saved Search Surface，继续复用服务端搜索与现有 Saved Search CRUD | `ReviewCardManage.vue` 2,462 行、22 个 direct `axios.` references、11 个 `v-dialog`；Card Info 与 Search Surface 各有单一职责所有者 | `docs/plans/review-card-manage-architecture-convergence-plan.md`；ADR-0012–0014、0017；2026-07-16 authenticated Chrome acceptance | Phase 3B-2 Authorized Next / Not Started；本轮停止 |
...
| 3 | Browser / ReviewCardManage convergence | Phase 3B-1 Accepted / Production Closed | Card Info Drawer 与 Search / Filter / Saved Search Surface 均已完成职责抽取和 authenticated Chrome/Network 验收；父组件 2,462 行；Phase 3B-2 Authorized Next / Not Started；见 `review-card-manage-architecture-convergence-plan.md` |
