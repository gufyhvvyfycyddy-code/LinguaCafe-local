...
**新的最推荐下一阶段**：候选 7b（TextBlockService 剩余 phrase/index/read data 逻辑继续拆解）或候选 5b（FsrsRescheduleConfirmApply-SafeWriteContractTests-1）或产品决策任务 `WordSenseService-DestroyRestoreProductDecision-1`（整理归档/永久删除产品语义）。
