...
以下任务为候选，均未冻结实现。C.15、C.16、C.17、C.18、C.20、C.20-a、C.21-scout、C.21-a、C.22-scout、C.22-a-lite、C.23-scout、C.24-scout、C.24-a-lite、D.1-scout、D.2-a、D.2-b 已完成。
...
**建议下一步**：D.2-c — 复习负担预估第一版（纯前端，用当前统计做粗略预估）。
...
**状态**：D.1-scout 已完成；D.2-a/D.2-b 已完成；D.2-c/D.2-d 为未冻结候选。
