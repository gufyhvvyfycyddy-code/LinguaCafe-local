...
以下任务为候选，均未冻结实现。C.15、C.16、C.17、C.18、C.20、C.20-a、C.21-scout、C.21-a、C.22-scout、C.22-a-lite、C.23-scout、C.24-scout、C.24-a-lite、D.1-scout、D.2-a、D.2-b、D.2-c 已完成。
...
**建议下一步**：D.3-a — 参数优化后端最小实现（详见 fsrs-parameter-optimization-plan.md）。
