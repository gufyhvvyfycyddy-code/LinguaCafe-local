...
| AI Study Card Phase 7 service convergence / lifecycle closure | `docs/superpowers/specs/2026-07-23-ai-study-card-service-convergence-design.md`、`docs/testing/ai-study-card-pending-lifecycle-service-browser-acceptance-2026-07-23.md` |
