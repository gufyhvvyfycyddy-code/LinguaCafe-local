...
- H-10 iOS capability probe：历史 Windows-only 边界见 `docs/testing/h10-ios-capability-probe-2026-08-29.md`；2026-08-30 macOS continuation 见 `docs/testing/h10-macos-xcode-simulator-capability-continuation-2026-08-30.md`，已真实证明 Xcode 26.6/SwiftPM/unsigned Simulator build + iPhone 17 Pro boot/install/launch + rendered login-shell Accessibility/tap/input/local-HTTP warning；authenticated server-bound iOS main-flow、真实 Keychain token runtime、physical device、signing/TestFlight/App Store 仍 DEFERRED
...
- H-GATE final audit：`docs/testing/h-gate-final-goal-completion-audit-2026-08-30.md`；Windows/Web/Android 已 stage-accepted，后续 cloud macOS continuation 又补齐 Xcode/SwiftPM/Simulator compile+launch 与 rendered login shell，但 E-08/H-10 的 authenticated server-bound iOS flow、真实 Keychain token runtime、physical device/signing/TestFlight/App Store 未清零，因此完整 A–H Goal 仍为 DEFERRED / Not Complete
