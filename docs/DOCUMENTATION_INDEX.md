...
> **Last updated**: 2026-07-07 (CodeX-AIStudyCardV6Preflight-1).
...
| `ai-study-card-v6-preflight-plan.md` | Frozen preflight; V6-1 implemented (2026-07-07) | V6 architecture gate for real AI recommendation. V6-1 adds provider-disabled request-package preview (`POST /ai-study-card/v6/recommendations/request-package`) plus desktop UI entry (`AiStudyCardV6RequestPackagePanel.vue`). Still does not authorize real provider calls or API keys. |
