...
| `ai-study-card-v6-preflight-plan.md` | Frozen preflight, not implemented (2026-07-07) | V6 architecture gate for real AI recommendation. Defines request/recommendation package schemas, provider boundary, forbidden shortcuts, staged implementation sequence, and guard requirements. Does not authorize real provider calls or API keys. |
