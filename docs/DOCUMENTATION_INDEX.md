...
| AI Study Card Phase 7 service convergence / lifecycle and package closure | `docs/superpowers/specs/2026-07-23-ai-study-card-service-convergence-design.md`、`docs/testing/ai-study-card-pending-lifecycle-service-browser-acceptance-2026-07-23.md`、`docs/testing/ai-study-card-candidate-package-service-acceptance-2026-07-23.md` |
