...
| `ai-study-card-v6-real-provider-implementation-plan.md` | Frozen plan; backend skeletons implemented disabled/fail-closed (2026-07-07) | V6-4/V6-7 real-provider implementation plan. Documents provider-preview route, prompt/response contract, OpenAI-compatible fake-transport adapter skeleton, UI boundary, fail-closed behavior, and browser Network smoke requirements. No live provider is bound or called. |
