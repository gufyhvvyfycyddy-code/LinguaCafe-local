...
| Module contracts | Stable module boundaries and output contracts | `docs/architecture/sense-http-controller-boundaries.md`, `docs/architecture/sense-review-module-boundaries.md`, `docs/plans/*contract*.md`, `docs/plans/*boundaries*.md` |
