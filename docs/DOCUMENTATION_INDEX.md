...
| `ai-study-card-v6-real-provider-implementation-plan.md` | Frozen plan only, not implemented (2026-07-07) | V6-4 real-provider implementation plan. Documents future provider-preview route, backend adapter boundary, UI boundary, fail-closed behavior, and browser Network smoke requirements without adding live provider code. |
