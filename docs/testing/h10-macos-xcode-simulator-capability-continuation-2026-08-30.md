...
- run `33425118337` verified the pinned Capacitor/Cordova `8.5.0` binary SDK artifacts: SwiftPM checksums matched, macOS code-signature verification passed, and the vendor signing identity was recorded. This is a current artifact verification record, not evidence of Apple Team app signing, TestFlight acceptance, or App Store submission.
