...
Route::group(['middleware' => ['auth', 'auth.session', 'web']], function () {
    ...
    Route::post('/vocabulary/words/batch-delete', [App\Http\Controllers\VocabularyController::class, 'batchDeleteWords']);
    ...
    Route::get('/senses/{id}/source-context-list', [App\Http\Controllers\SenseOccurrenceController::class, 'sourceContextList']);
